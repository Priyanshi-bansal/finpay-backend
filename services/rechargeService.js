...
const { generateChecksum } = require('../utils/checkSumGeneration');
const secretKey = 'abcd@123';

const MOBIKWIK_API_URL = "https://alpha3.mobikwik.com/rechargeStatus.do";
const MOBIKWIK_BALANCE_API_URL = "https://alpha3.mobikwik.com/recharge/v1/retailerBalance";
const MOBIKWIK_view_bill_URL = " https://alpha3.mobikwik.com/retailer/v2/retailerViewbill";
...
const rechargeValidation = async (uid, password, amt, cir, cn, op, adParams) => {
    ...
    const checksum = generateChecksum(body, secretKey);
    ...
    try {
        ...
        return { status: error.response?.status || 500, data: error.response?.data || { message: 'API request failed' } };
    }
};
...
module.exports = { rechargeValidation, recharge,checkRechargeStatus,checkRetailerBalance ,viewbill};
